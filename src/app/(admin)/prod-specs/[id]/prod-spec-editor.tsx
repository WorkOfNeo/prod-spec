            ...
            {outputs.map((o, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Carton barcode preference — CARTON_MARKING outputs only.
                      EAN-128 = Code 128 bars + number beneath (the default);
                      EAN-13 = digits inside the symbol. Height overrides the
                      renderer default (16 mm coded template / font-scaled in
                      builder layouts). */}
