...
export const spec: PrintSpec = {
  id: 'ge-kas-ullared-private-label-washcare-label-layout',
  customer: 'Ge-kås Ullared',
  businessArea: 'Private label',
  printType: 'wash-care-label',
  renderStrategy: 'dynamic',
  sourcePdf: 'Ge-kås Ullared-Private label-Washcare label layout.pdf',
  ...
  parts: [
    {
      ...
      fields: [
        { key: 'sizes', required: true, source: 'po', notes: 'Example shows 5 size breaks (128-170), one column per size' },
        { key: 'ean13', required: true, source: 'po', notes: 'Marker \'EAN CODE\'; EAN-13 under each size column' },
      ],
    },
    {
      id: 'label2-front',
  ...
  notes: '\'LABEL 1/2/3\' care label (square layout doc): label 1 is 35×45 mm single-sided; labels 2-3 are 35×90 mm printed front/back. No customer item number on label 1 in this layout.',
};
