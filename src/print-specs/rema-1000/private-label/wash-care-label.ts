...
export const spec: PrintSpec = {
  id: 'rema-1000-private-label-wash-care-label',
  customer: 'Rema 1000',
  businessArea: 'Private Label',
  printType: 'wash-care-label',
  renderStrategy: 'dynamic',
  sourcePdf: 'Rema 1000-Private Label-Wash Care Label.pdf',
  ...
  parts: [
    {
      ...
      fields: [
        ...
        { key: 'batchNo', required: true, source: 'po', notes: 'Rendered \'Batch no.\'' },
        { key: 'articleNo', required: true, source: 'po', notes: 'Rendered \'Article no.\'' },
      ],
    },
    {
      id: 'sheet2-front',
  ...
  currency: 'NOK',
  notes: 'Sewn wash care label: width 35 mm, finished length 90 mm (callout \'Width- 35mm, finished length- 90mm\'). Sheet 1 single-sided; sheets 2-3 printed front/back. Rema variant: sheet 1 also carries retail price, batch no. and article no. Quality: \'White soft Stain, no burned edges\'.',
};
